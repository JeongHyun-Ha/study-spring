...
//        model.addAttribute("age", 30);
    ...
    public void method4(Model model) {
        ...
        model.addAttribute("myList2", List.of("a", "b", "C"));
        model.addAttribute("myMap2", Map.of("a", "b", "c", "d", "e", "f"));
    }

    @RequestMapping("sub5")
    public void method5(Model model) {
        model.addAttribute("myList", List.of("java", "css", "html", "react", "spring"));
    }
    ...
    public void method7(Model model) {
        ...
        MyBean122 e2 = new MyBean122("김하성", "샌디에디고", "한국", "야구", List.of("유격수", "2루수"));
